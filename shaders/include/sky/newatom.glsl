...
const float sky_coefficientRayleighR = 5.8;
const float sky_coefficientRayleighG = 1.35;
const float sky_coefficientRayleighB = 3.31;
const float sky_coefficientMieR = 3.0;
const float sky_coefficientMieG = 3.0;
const float sky_coefficientMieB = 3.0;
const float rPI = 1.0 / 3.1415926535897932384626433832795;
const float rLOG2 = 1.0 / log(2.0);
const float sky_mieg =0.8;

const vec3 sunColorBase = vec3(1.0, 0.91, 0.81) * 128000;
const vec3 moonColorBase = vec3(0.908, 0.912, 0.895) * 200;
